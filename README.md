...
## Task Description
![alt text](./COVID'19-Infection.png)
Figure 1. Example of COVID-19 infected regions in CT axial slice, where the red and green masks denote the GGO and consolidation,

...
== Note that ==: In our manuscript, we said that the total training images are 50. However, we found there are two images with very small resolution and black ground-truth. Thus, we discard these two images in our training set. The above link only contains 48 training images. 
